...
public class SpaghettiCodePage extends DialogWrapper implements AbstractCodeSmellGUI {
    ...
    public SpaghettiCodePage(ClassBean classBeanSpaghettiCode, Project project) {
        super(true);
    ...
    public JComponent createCenterPanel() {
        ...
        tableElemet.add(CKMetrics.getLOC(classBeanSpaghettiCode) + "");
